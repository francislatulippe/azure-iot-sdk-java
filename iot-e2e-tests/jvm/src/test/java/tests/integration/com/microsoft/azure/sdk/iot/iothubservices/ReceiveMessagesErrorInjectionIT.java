...
import com.microsoft.azure.sdk.iot.common.iothubservices.ReceiveMessagesErrorInjectionCommon;
...
public class ReceiveMessagesErrorInjectionIT extends ReceiveMessagesErrorInjectionCommon
{
    ...
    public static Collection inputs() throws IOException, IotHubException, GeneralSecurityException, URISyntaxException, ModuleClientException
    {
        ...
        return ReceiveMessagesErrorInjectionCommon.inputsCommon();
    }

    public ReceiveMessagesErrorInjectionIT(InternalClient client, IotHubClientProtocol protocol, Device device, Module module, AuthenticationType authenticationType, String clientType)
    {
