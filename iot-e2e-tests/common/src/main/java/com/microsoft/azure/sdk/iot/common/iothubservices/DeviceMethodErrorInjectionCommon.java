 ...
 */
public class DeviceMethodErrorInjectionCommon extends MethodNameLoggingIntegrationTest
{
    ...
    private DeviceMethodErrorInjectionCommon.DeviceMethodITRunner testInstance;
    ...
    public DeviceMethodErrorInjectionCommon(DeviceTestManager deviceTestManager, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, Device device, Module module)
    {
        super();
