...
public class SubscribeToDesiredPropertiesErrorInjectionCommon extends DeviceTwinErrorInjectionCommon
{
    public SubscribeToDesiredPropertiesErrorInjectionCommon(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType)
    {
